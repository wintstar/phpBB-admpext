...
$lang = array_merge($lang, array(
	...
	'ACP_TOOLKIT_TOKEN_EXPLAIN'			=> 'Hier werden für den Gründer Sicherheits-Token generiert. Diese werden zum Anmelden im AdminPlus (ADMP) benötigt, wenn die Datenbank-Verbindung nicht besteht bzw . beschädigt ist.<br>
		!!! Kopiere diese Sicherheits-Token und speichere diese an einem sicheren Ort !!!',
	...
	'ACP_TOOLKIT_STORE_TOKEN'			=> 'Kopiere diese Notfall Anmelde-Daten',
	'ACP_TOOLKIT_EMERGENCY'				=> 'Notfall Anmelde-Daten',
	'ACP_TOOLKIT_EMERGENCY_CHECK'		=> 'Notfall Token',
	'ACP_TOOLKIT_COPY_FAIL'				=> 'Das kopieren der Token-Datei in das Verzeichnis „%s“ schlug fehl. Prüfe bitte ob das Verzeichnis beschreibbar bzw vorhanden ist.',
	'ACP_TOOLKIT_NO_PARAM_DIR'			=> 'Verzeichnis „%s“ wurde nicht gefunden. Bitte prüfe ob das Verzeichnis beschreibbar bzw vorhanden ist.',

	'ACP_TOOLKIT_BOARD_TOKEN_CHECK'		=> array(
		1 =>	'Token sind identisch',
		2 =>	'Token sind nicht identisch. Es werden neue generiert.',
	),
